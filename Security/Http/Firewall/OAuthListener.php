...
namespace MobileCart\HWIOAuthBundle\Security\Http\Firewall;
 ...
 * @author Jesse Hanson <jesse@mobilecart.io>
 */
class OAuthListener extends AbstractAuthenticationListener
{
    ...
    protected function attemptAuthentication(Request $request)
    {
        ...
        $accessToken = $request->get('type', '') == 'access'
            ? $request->get('code', '')
            : $resourceOwner->getAccessToken(
                $request,
